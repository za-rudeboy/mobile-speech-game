...
export const MVP_V1_GAME_COPY = {
  ...
  daily_phrase_practice: {
    ...
    feedback: {
      want_banana: 'i want a banana please.',
      help_box: 'help me please.',
      all_done_puzzle: 'All done.',
      hand_hurts: 'My hand hurts.',
      want_water: 'I want water please.',
      want_apple: 'i want an apple please.',
    },
  },
  do_what_i_say: {
    prompts: {
